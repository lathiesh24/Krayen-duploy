    ...
    <div className="flex flex-col justify-center w-4/5 pt-20 pb-40 pl-96">
      ...
      {posts.map((post) => {
        ...
        return (
          <li
            key={post.id}
            className="flex flex-col min-h-[150px]  md:max-w-xl rounded-lg bg-white shadow-lg mb-20 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:drop-shadow-2xl duration-300 cursor-pointer p-5"
          >
            <h3 className="p-3 ">
              <Link href={`/${post.id}`}>
